...
public:
    void init(){
        ...
        ///--- Vertex coordinates
        {
            const GLfloat vpoint[] = { /*V1*/ -1.0f, -1.0f, 2.0f,
                                       /*V2*/ +1.0f, -1.0f, 2.0f,
                                       /*V3*/ -1.0f, +1.0f, 2.0f,
                                       /*V4*/ +1.0f, +1.0f, 2.0f };
            ///--- Buffer
        ...
        ///--- Texture coordinates
        {
           // const GLfloat vtexcoord[] = { /*V1*/ 0.0f, 0.0f,
            ...
            const GLfloat vtexcoord[] = {     -1.0f,-1.0f,-1.0f, // triangle 1 : begin
                                              -1.0f,-1.0f, 1.0f,
        ...
        OpenGP::imread("Quad/sky.tga", image);
    ...
    void draw(mat4 Model, mat4 View, mat4 Projection){
            ...
            glBindVertexArray(_vao);
                ...
                ///--- Draw
                //glDrawArrays(GL_TRIANGLE_STRIP, 0, 4);//gl_triangles, 4 is # of verticies
